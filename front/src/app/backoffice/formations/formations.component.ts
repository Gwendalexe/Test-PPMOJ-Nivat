...
export class FormationsComponent {
  ...
  constructor(private formationService: FormationService) {
    this.formationService.getFormationCategories().subscribe(cat => {
      // Only show non-HISTOIRE categories (PROBLEME, etc.)
      const formationCategories = cat.filter((category: any) => category.code !== 'HISTOIRE');
      formationCategories.forEach((category: any) => {
        ...
        this.formationService
          ...
          .subscribe(data => {
            const uniqueFormations = data.filter(
  ...
  onSubmit(id: number, form: FormGroup) {
    ...
    this.formationService
      ...
      .subscribe(() => {
        console.log('Formation category updated');
      });
  }
        ...
        formationCategories.forEach((category: any) => {
          this.formationService
            ...
            .subscribe(data => {
              ...
              this.categories[category.id].formations = uniqueFormations;
            });
        });
      });
    });
